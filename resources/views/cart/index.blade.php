<x-app-layout>
	<div class="container mx-auto px-4 py-8">
		...
		@if(session()->has('info'))
		<div class="mb-6 flex items-center gap-4 bg-blue-500/10 border border-blue-500/50 p-4 rounded-2xl backdrop-blur-md">
			...
			<button type="button" onclick="this.parentElement.remove()" class="ml-auto text-blue-400 hover:text-white">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd"
