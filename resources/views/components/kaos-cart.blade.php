<div
    ...
    <div
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" wire:model="selectedItems" value="{{ $keranjang->id }}"
                ...
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-base font-semibold text-gray-900 dark:text-white">
                                    Rp {{ number_format($keranjang->kaos->harga, 0, ',', '.') }}
                                </span>
                            </div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div
                                    ...
                                    <button wire:click="decrementQuantity({{ $keranjang->id }})"
                                        ...
                                        @if($keranjang->qty <= 1) disabled @endif>
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M20 12H4" />
                                            </svg>
                                    </button>
                                    <input type="number" wire:model.blur="quantities.{{ $keranjang->id }}"
                                        value="{{ $keranjang->qty }}" min="1"
                                    ...
                                    <button wire:click="incrementQuantity({{ $keranjang->id }})"
                    ...
                    <div class="flex flex-col items-end gap-3">
                        ...
                        <div class="flex gap-2">
                            <button wire:click="saveForLater({{ $keranjang->id }})"
                                class="p-2 text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200"
    ...
    @if(isset($keranjang->kaos->stok) && $keranjang->kaos->stok < 5) <div
        ...
        <div class="flex items-center gap-2 text-yellow-800 dark:text-yellow-200">
            ...
            <p class="text-sm font-medium">Only {{ $keranjang->kaos->stok }} items left in stock!</p>
        </div>
</div>
@endif
</div>